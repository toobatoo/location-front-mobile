...
export class CalendarComponent implements OnInit {
  ...
  public input_start_date;
  public input_stop_date;
  public fabRipple;
  ...
  ngOnInit() {
    this.input_start_date = new MDCTextField(document.querySelector('.input-start-date'));
    this.input_stop_date = new MDCTextField(document.querySelector('.input-stop-date'));
    this.fabRipple = new MDCRipple(document.querySelector('.mdc-button'));
    this.beforInitMonth();
    this.getDate();
  }
